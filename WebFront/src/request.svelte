<script>
    ...
    var httpPost = new XMLHttpRequest(),
        path = "http://127.0.0.1:8000/upload/" + name,
    ...
    var uploadImage = function(src, name_, type){
    convertToBase64(src, type, function(data){
        sendBase64ToServer(name_, data);
    });
    };
    ...
    // uploadImage(imgsrc, name_, 'image/jpeg')
...
<button class='buttons' type='button' on:click={doPost}>
    Run
</button>

<button class='buttons' type='button' on:click={cancel}>
    Cancel
</button>